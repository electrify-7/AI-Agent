OUTBOUND_CONVERSATION_STAGES = {
    ...
    "4": "Product Suggestion: Suggest upto 3 products that can benefit the prospect. Ask them which of these would be the most suitable.",
    "5": "Product details: Tell customer the details/specifications of the selected product. Also the discount calculaton function will be called in this stage.",
    "6": "Objection handling: Address any objections that the prospect may have regarding your product. If pricing is a concern, you may offer the earlier calculated discount based on the sentiment analysis to help overcome the objection and move the conversation forward. Be prepared to provide evidence or testimonials to support your claims.",
    "7": "Close: Ask for the sale by proposing a next step. This could be a visit to the store, or order confirmation. The summariser function will also be called here.",
